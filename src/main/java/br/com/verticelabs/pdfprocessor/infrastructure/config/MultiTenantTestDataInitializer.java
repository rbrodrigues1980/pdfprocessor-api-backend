...
public class MultiTenantTestDataInitializer implements CommandLineRunner {
    ...
    private static final String SUPER_ADMIN_EMAIL = "superadmin@teste.com";
    ...
    private static final String TENANT1_ADMIN_EMAIL = "admin@teste.com";
    private static final String TENANT1_ADMIN_PASSWORD = "Admin123!";
    private static final String TENANT1_USER_EMAIL = "usuario@teste.com";
    private static final String TENANT1_USER_PASSWORD = "Usuario123!";
    ...
    private static final String TENANT2_ADMIN_PASSWORD = "Admin456!";
    private static final String TENANT2_USER_EMAIL = "usuario@demo.com";
    private static final String TENANT2_USER_PASSWORD = "Usuario456!";
